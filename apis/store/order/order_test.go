...
func TestGetByFilter(t *testing.T) {
	...
	var resp []byte
	test.MockSvrHandler.HandleFunc(apiGetByFilter, func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp = mockResp[tt.name]
			gotResp, err := GetByFilter(tt.args.ctx, tt.args.payload)
			//fmt.Println(string(gotResp), err)
			if (err != nil) != tt.wantErr {
			...
			if !reflect.DeepEqual(gotResp, tt.wantResp) {
				t.Errorf("GetByFilter() gotResp = %v, want %v", gotResp, tt.wantResp)
			}
		})
	}
}
func TestSetDelivery(t *testing.T) {
	...
	var resp []byte
	test.MockSvrHandler.HandleFunc(apiSetDelivery, func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp = mockResp[tt.name]
			gotResp, err := SetDelivery(tt.args.ctx, tt.args.payload)
			//fmt.Println(string(gotResp), err)
			if (err != nil) != tt.wantErr {
				t.Errorf("SetDelivery() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(gotResp, tt.wantResp) {
				t.Errorf("SetDelivery() gotResp = %v, want %v", gotResp, tt.wantResp)
			}
		})
	}
}
func TestClose(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp = mockResp[tt.name]
			gotResp, err := Close(tt.args.ctx, tt.args.payload)
			//fmt.Println(string(gotResp), err)
			if (err != nil) != tt.wantErr {
